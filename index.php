...
если вы его не устанавливали себе на компьютер, то можете воспользоваться сайтом https://www.w3schools.com/php/phptryit.asp?filename=tryphp_compiler -->

<?php
	$name = "Vladimir Artamonov";
    $profession = "Senior Analyst";
    $city = "Moscow";
    $email = "tomodachiva@gmail.com";
    $phone = "+7(916)984-92-44";
    $currentYear = "2022";
    $birthYear = "1982";
    ...
    $experience = [
    ["jobPosition" => "Senior Analyst", "startDate" => "Aug 2022", "endDate" => "Current", "company" => "Polyplast","description" => "Not prepared"],
    ["jobPosition" => "Head of Marketing Department", "startDate" => "May 2020", "endDate" => "January 2021", "company" => "EUROCEMENT group","description" => "Bla-Bla-Bla"],
	["jobPosition" => "Marketing and Business Intelligence Expert ", "startDate" => "December 2018", "endDate" => "May 2020", "company" => "GREYCO (Consulting)","description" => "Bla-bla-bla"],
	];
    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        ...
        <div class="w3-container">
          ...
          <p><i class="fa fa-calendar fa-fw w3-margin-right w3-large w3-text-teal"></i><?php echo $birthYear ?></p>
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <?php for ($i = 0; $i < count($experience); $i++): ?>
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?php echo $experience[$i]["jobPosition"]; ?></b></h5>
            	<h6 class="w3-opacity"><b><?php echo $experience[$i]["company"]; ?></b></h6>
            		<h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $experience[$i]["startDate"]; ?> - <?php echo $experience[$i]["endDate"]; ?></span></h6>
